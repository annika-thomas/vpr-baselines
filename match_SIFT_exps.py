...
def main(args):
    ...
    for experimentName in matchingConfig.experiments:
        ...
        input_file_path1 = os.path.join(output_directory, f'test{dataset1Name}_sift.pickle')
        ...
        input_file_path2 = os.path.join(output_directory, f'test{dataset2Name}_sift.pickle')
        ...
        output_file_path = output_directory + f'test{dataset1Name}_test{dataset2Name}_sift.pickle'
